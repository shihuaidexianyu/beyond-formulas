...
零特征值要单独处理，因为那些方向上 \(A\) 不可逆，上面的配方做不了。留下来的线性项若在零方向上非零，图形沿该方向被抛物线状地推出去，得到抛物型；若线性项在零方向上也为零，方程退化成平面、直线、锥面或空集。这正是``看起来像''最容易出岔子的地方：\(x^2+y^2=0\) 在实平面上只有一个点，可它的写法和一族圆完全同形。
