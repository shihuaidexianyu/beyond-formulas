...
\begin{tikzpicture}[x=1cm,y=1cm,font=\small,>=stealth]
  ...
  \begin{scope}[shift={(5.4,0)}]
    \draw[black!30,dashed] (1.4,0.8) circle (0.85);
    \draw[black!30,dashed] (2.7,1.2) circle (0.85);
    \fill[black!85] (1.4,0.8) circle (2.2pt);
    \fill[black!85] (2.7,1.2) circle (2.2pt);
    \fill[blue!75] (1.96,1.29) circle (2pt);
    \fill[blue!75] (2.14,0.71) circle (2pt);
    \draw[->,red!75] (1.915,1.251) -- (1.475,0.866);
    \draw[->,red!75] (2.185,0.749) -- (2.625,1.134);
    \node[font=\footnotesize,black!70,align=center] at (2.05,-0.35) {噪声云重叠处，\\两个方向被平均};
  \end{scope}
