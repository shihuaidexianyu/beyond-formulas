...
需要更多背景的话，浮点数的表示与抵消现象在\hyperref[ch:061]{``浮点数与误差：计算机为什么不等于实数系统''}里；分解、主元与迭代解法的完整讨论在\hyperref[ch:065]{``数值线性代数：结构、规模与保证的强弱决定算法''}里。前一单元：\hyperref[ch:066]{``常微分方程数值方法：沿局部斜率走完整条轨迹''}。
